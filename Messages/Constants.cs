namespace Messages
{
    ...
    {
        public const string EXCHANGE_DIRECT_DEMO = "exchange-direct-demo";
        public const string EXCHANGE_TOPIC_DEMO = "exchange-topic-demo";
        public const string EXCHANGE_HEADER_DEMO = "exchange-header-demo";

        public const string QUEUE_DEMO_DIRECT = "queue-demo-direct";
